...
class SpeedPick {
  static final Dio _d = Dio(BaseOptions(connectTimeout: const Duration(seconds: 3), receiveTimeout: const Duration(seconds: 3)));
  ...
  static Future<String?> bestUrl(Movie m) async {
    ...
    try {
      // ✅ التعديل: تقليل حجم الاختبار من 256KB إلى 2KB فقط
      const bytes = 2 * 1024;
